...
#import "touch12ifAppDelegate.h"
#import "touch12ifViewController.h"

@implementation touch12ifAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
    ...
    if (pheight >= 568.0f) {
        self.viewController = [[touch12ifViewController alloc] initWithNibName:@"touch12ifViewController_iPhone5" bundle:nil];
    } else {
        self.viewController = [[touch12ifViewController alloc] initWithNibName:@"touch12ifViewController" bundle:nil];
    }
